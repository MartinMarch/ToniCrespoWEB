...
const translations = {
  es: {
    ...
    contact: {
      ...
      emailAppHint: "Se abrirá tu aplicación de correo para revisar y enviar el borrador. Necesitas tener una cuenta de correo configurada en ella.",
  ...
  en: {
    ...
    contact: {
      ...
      emailAppHint: "Your email app will open so you can review and send the draft. You need an email account configured in that app.",
  ...
  de: {
    ...
    contact: {
      ...
      emailAppHint: "Ihr E-Mail-Programm öffnet sich, damit Sie den Entwurf prüfen und senden können. Dafür muss dort ein E-Mail-Konto eingerichtet sein.",
  ...
  ca: {
    ...
    contact: {
      ...
      emailAppHint: "S'obrirà la teva aplicació de correu per revisar i enviar l'esborrany. Cal tenir-hi un compte de correu configurat.",
